...
class ServiceManagementService(_ServiceManagementClient):
    ...
    def add_role(self, service_name, deployment_name, role_name, system_config,
                 ...
                 availability_set_name=None, data_virtual_hard_disk=None,
    ...
    def set_network(self, conf_xml):
        '''Config network.
        '''
        return self._perform_put(self._get_network_conf_site_path(), 
                                 conf_xml, 
    ...
    def _get_network_conf_site_path(self):
        return self._get_path('services/networking/media', None)
